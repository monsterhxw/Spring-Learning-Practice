package geektime.spring.mybatis.generator.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Tue Aug 27 17:19:39 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=geektime.spring.mybatis.generator.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("geektime.spring.mybatis.generator.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=geektime.spring.mybatis.generator.handler.MoneyTypeHandler},",
