...
public class CustomerRunner implements ApplicationRunner {
    ...
    private Link getLink(URI uri, String rel) {
        ResponseEntity<Resources<Link>> rootResp = restTemplate.exchange(
            uri,
            HttpMethod.GET,
            null,
    ...
    private void readCoffeeMenu(Link coffeeLink) {
        ResponseEntity<PagedResources<Resource<Coffee>>> coffeeResp = restTemplate.exchange(
            coffeeLink.getTemplate().expand(),
            HttpMethod.GET,
            null,
    ...
    private Resource<Coffee> addCoffee(Link link) {
        ...
        ResponseEntity<Resource<Coffee>> resp = restTemplate.exchange(
            req,
    ...
    private void addOrder(Link link, Resource<Coffee> coffee) {
        ...
        ResponseEntity<Resource<CoffeeOrder>> resp = restTemplate.exchange(
            req,
